...
def encode(self, text: str) -> List[str]:
        ...
        Returns:
            List[str]: list of subwords and delimiters (the encoded text). 
            Example: "↑ tam ¦ pśe póda jo ¦ koncer n ¦ tak ¦ pomjen jony ¦ awto ¦ ."
        """
...
def decode(self, encoded_text: str) -> str:
        ...
        Args:
            encoded_text (str): text to decode. 
            Example: "↑tam¦pśepódajo¦koncern¦tak¦pomjenjony¦awto¦."

        Returns:
            str: decoded text, without delimiters and 
                 other special characters used for tokenization
        """
        result = []
        ...
        while i < len(encoded_text):
            ...
            # The token delimeter is equal to have a whitespace 
            # (even if it's not totally correct, but it works well)
